...
create_acceuilw (void)
{
  ...
  label2 = gtk_label_new_with_mnemonic (_("Gestion election"));
...
create_gestionw (void)
{
  ...
  gtk_window_set_title (GTK_WINDOW (gestionw), _("gestion election"));
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), entry5w, 168, 72);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), entry3w, 168, 144);
  gtk_widget_set_size_request (entry3w, 160, 27);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry3w), 8226);

  label11w = gtk_label_new (_("<span foreground=\"black\" ><b>Ajouter election:</b></span>"));
  ...
  label10w = gtk_label_new (_("<span foreground=\"red\" ><b>Saisir nombreconseiller !</b></span>"));
  gtk_fixed_put (GTK_FIXED (fixed3), label10w, 152, 160);
  gtk_widget_set_size_request (label10w, 216, 64);
  gtk_label_set_use_markup (GTK_LABEL (label10w), TRUE);

  label3w = gtk_label_new (_("Nombre conseiller: "));
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), combobox1w, 168, 224);
  gtk_widget_set_size_request (combobox1w, 160, 40);
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox1w), _("m1"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox1w), _("m2"));

  label6w = gtk_label_new (_("municipalite "));
  gtk_widget_show (label6w);
  gtk_fixed_put (GTK_FIXED (fixed3), label6w, 32, 224);
  gtk_widget_set_size_request (label6w, 136, 48);
  gtk_label_set_use_markup (GTK_LABEL (label6w), TRUE);

  label13w = gtk_label_new (_("<span foreground=\"red\" ><b>Saisir id !</b></span>"));
  gtk_fixed_put (GTK_FIXED (fixed3), label13w, 144, 96);
  gtk_widget_set_size_request (label13w, 128, 40);
  gtk_label_set_use_markup (GTK_LABEL (label13w), TRUE);

  label5w = gtk_label_new (_("nombre habitant"));
  gtk_widget_show (label5w);
  gtk_fixed_put (GTK_FIXED (fixed3), label5w, 32, 304);
  gtk_widget_set_size_request (label5w, 128, 48);

  label4w = gtk_label_new (_("       Date  : "));
  gtk_widget_show (label4w);
  gtk_fixed_put (GTK_FIXED (fixed3), label4w, 576, 96);
  gtk_widget_set_size_request (label4w, 200, 40);

  label35w = gtk_label_new (_("<span foreground=\"green\" ><b> election   ajout\303\251 avec succes !</b></span>"));
  gtk_fixed_put (GTK_FIXED (fixed3), label35w, 592, 0);
  gtk_widget_set_size_request (label35w, 264, 56);
  gtk_label_set_use_markup (GTK_LABEL (label35w), TRUE);

  label34w = gtk_label_new (_("<span foreground=\"red\" ><b> election existant !</b></span>"));
  gtk_fixed_put (GTK_FIXED (fixed3), label34w, 296, 56);
  gtk_widget_set_size_request (label34w, 216, 64);
  gtk_label_set_use_markup (GTK_LABEL (label34w), TRUE);

  label8w = gtk_label_new (_("<span foreground=\"red\" ><b>Saisir  nbr habitant !</b></span>"));
  gtk_fixed_put (GTK_FIXED (fixed3), label8w, 136, 344);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), combobox2w, 168, 320);
  gtk_widget_set_size_request (combobox2w, 160, 39);
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox2w), _("1"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox2w), _("2"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox2w), _("3"));

  label7w = gtk_label_new (_("<span foreground=\"red\" ><b>Saisir municiopalite  !</b></span>"));
  gtk_fixed_put (GTK_FIXED (fixed3), label7w, 144, 248);
  ...
  label37w = gtk_label_new (_("<span foreground=\"green\" ><b>election Modifi\303\251 avec succes </b></span>"));
  ...
  label36w = gtk_label_new (_("<span foreground=\"black\" ><b>Modifier election de id  :</b></span>"));
  ...
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox4w), _("1"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox4w), _("2"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox4w), _("3"));
  ...
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox3w), _("m1"));
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox3w), _("m2"));
  ...
  label28w = gtk_label_new (_("<span foreground=\"black\" ><b>Saisirid !</b></span>"));
  ...
  gtk_fixed_put (GTK_FIXED (fixed6), radiobutton1, 360, 80);
  ...
  g_signal_connect ((gpointer) button3, "clicked",
                    G_CALLBACK (on_Ajouterelection_clicked),
                    NULL);
  g_signal_connect ((gpointer) button4w, "clicked",
                    G_CALLBACK (on_Modifierelection_clicked),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (gestionw, checkbutton1, "checkbutton1");
  GLADE_HOOKUP_OBJECT (gestionw, radiobutton2, "radiobutton2");
  GLADE_HOOKUP_OBJECT (gestionw, radiobutton1, "radiobutton1");
